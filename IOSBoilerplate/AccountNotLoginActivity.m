...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
  if ([DeviceInformation isIPhone5]) {
    ...
    self = [super initWithNibName:@"AccountNotLoginActivity_iphone5" bundle:nibBundleOrNil];
  } else {
    self = [super initWithNibName:@"AccountNotLoginActivity" bundle:nibBundleOrNil];
  }
  if (self) {
