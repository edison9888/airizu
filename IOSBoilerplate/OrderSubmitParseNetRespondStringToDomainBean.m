//
//  OrderSubmitParseNetRespondStringToDomainBean.m
//  airizu
//
...
static const NSString *const TAG = @"<OrderSubmitParseNetRespondStringToDomainBean>";

@implementation OrderSubmitParseNetRespondStringToDomainBean
- (id) init {
...
- (id) parseNetRespondStringToDomainBean:(in NSString *) netRespondString {
  do {
    ...
    return [OrderSubmitNetRespondBean orderSubmitNetRespondBeanWithOrderId:orderId
