//
//  ForgetPasswordNetRespondBean.m
//  airizu
//
...
static const NSString *const TAG = @"<ForgetPasswordNetRespondBean>";
...
+(id)forgetPasswordNetRespondBeanWithMessage:(NSString *)message {
  return [[[ForgetPasswordNetRespondBean alloc] initWithMessage:message] autorelease];
}
