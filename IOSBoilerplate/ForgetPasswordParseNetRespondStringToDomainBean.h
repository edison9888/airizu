//
//  ForgetPasswordParseNetRespondStringToDomainBean.h
//  airizu
//
...
@interface ForgetPasswordParseNetRespondStringToDomainBean : NSObject <IParseNetRespondStringToDomainBean> {
