//
//  ForgetPasswordParseNetRespondStringToDomainBean.m
//  airizu
//
...
#import "ForgetPasswordParseNetRespondStringToDomainBean.h"
...
static const NSString *const TAG = @"<ForgetPasswordParseNetRespondStringToDomainBean>";

@implementation ForgetPasswordParseNetRespondStringToDomainBean
- (id) init {
...
- (id) parseNetRespondStringToDomainBean:(in NSString *) netRespondString {
  do {
    ...
    NSString *message = [jsonRootNSDictionary safeStringObjectForKey:k_ForgetPassword_RespondKey_message withDefaultValue:defaultValueForString];
    
    return [ForgetPasswordNetRespondBean forgetPasswordNetRespondBeanWithMessage:message];
