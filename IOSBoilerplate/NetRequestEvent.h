...
@property (nonatomic, readonly) NSString *abstractFactoryMappingKey;
// 控制层 对此次网络请求的标识
@property (nonatomic, readonly) NSUInteger requestEventEnum;
// 控制层 的代理对象
@property (nonatomic, readonly) id<IDomainNetRespondCallback> netRespondDelegate;
// Http请求参数集合
@property (nonatomic, readonly) NSDictionary *httpRequestParameterMap;
