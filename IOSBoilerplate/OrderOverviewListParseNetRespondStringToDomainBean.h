//
//  OrderOverviewListParseNetRespondStringToDomainBean.h
//  airizu
//
...
@interface OrderOverviewListParseNetRespondStringToDomainBean : NSObject <IParseNetRespondStringToDomainBean> {
