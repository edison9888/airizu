//
//  ReviewSubmitParseNetRespondStringToDomainBean.m
//  airizu
//
...
#import "ReviewSubmitParseNetRespondStringToDomainBean.h"
...
static const NSString *const TAG = @"<ReviewSubmitParseNetRespondStringToDomainBean>";

@implementation ReviewSubmitParseNetRespondStringToDomainBean
- (id) init {
...
- (id) parseNetRespondStringToDomainBean:(in NSString *) netRespondString {
  do {
    ...
    NSString *message = [jsonRootNSDictionary safeStringObjectForKey:k_ReviewSubmit_RespondKey_message withDefaultValue:defaultValueForString];
    
    return [ReviewSubmitNetRespondBean reviewSubmitNetRespondBeanWithMessage:message];
  } while (NO);
