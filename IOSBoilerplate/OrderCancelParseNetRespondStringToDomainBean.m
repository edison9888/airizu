//
//  OrderCancelParseNetRespondStringToDomainBean.m
//  airizu
//
...
static const NSString *const TAG = @"<OrderCancelParseNetRespondStringToDomainBean>";

@implementation OrderCancelParseNetRespondStringToDomainBean
- (id) init {
...
- (id) parseNetRespondStringToDomainBean:(in NSString *) netRespondString {
  do {
    ...
    // 关键数据字段检测
    NSString *message = [jsonRootNSDictionary safeStringObjectForKey:k_OrderCancel_RespondKey_message withDefaultValue:@""];
    
    return [OrderCancelNetRespondBean orderCancelNetRespondBeanWithMessage:message];
  } while (NO);
