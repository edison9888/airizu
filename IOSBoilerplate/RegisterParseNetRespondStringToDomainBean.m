//
//  RegisterParseNetRespondStringToDomainBean.m
//  airizu
//
...
#import "RegisterParseNetRespondStringToDomainBean.h"
...
static const NSString *const TAG = @"<RegisterParseNetRespondStringToDomainBean>";

@implementation RegisterParseNetRespondStringToDomainBean
- (id) init {
...
- (id) parseNetRespondStringToDomainBean:(in NSString *) netRespondString {
  do {
    ...
    NSString *message = [jsonRootNSDictionary safeStringObjectForKey:k_Register_RespondKey_message withDefaultValue:defaultValueForString];
    
    return [RegisterNetRespondBean registerNetRespondBeanWithMessage:message];
